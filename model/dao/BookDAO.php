<?php
// model/dao/BookDAO.php — Capa de acceso a datos para libros (usa PDO con sentencias preparadas)
...
class BookDAO {
    ...
    public function getBookByIsbn($isbn) {
        try {
            ...
            error_log("Error en BookDAO::getBookByIsbn: " . $e->getMessage());
            return false;
        }
    }

    /**
     * Crea un nuevo libro con su autor asociado.
     * Usa execute(array) para vincular parámetros de forma segura.
     */
    public function createBookWithAuthor($isbn, $title, $pages, $stock, $synopsis, $price, $editorial, $coverName, $authorId) {
        try {
            ...
            error_log("Error en BookDAO::createBookWithAuthor: " . $e->getMessage());
            return false;
        }
    }

    /**
     * Obtiene todos los libros del catálogo mediante procedimiento almacenado.
     */
    public function getAllBooks() {
        try {
            ...
            error_log("Error en BookDAO::getAllBooks: " . $e->getMessage());
            return false;
        }
    }
    ...
    public function updateBook(Book $book) {
        try {
            ...
            error_log("Error en BookDAO::updateBook: " . $e->getMessage());
            return false;
        }
    }
}
